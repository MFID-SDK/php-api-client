...
class Customer
{
    ...
    public function get($customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('merchant/customer.get', [
            'token'       => $api->token,
    ...
    public function add($phone, $card, $offer_id, $address_id = null, $name = null, $email = null, $birthday = null, $status = null)
    {
        ...
        $data = $api->call('merchant/customer.add', [
            'token'       => $api->token,
            'phone'       => $phone,
            'card'        => $card,
    ...
    public function balanceGet($address_id = 0, $balance_id = 1, $customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('merchant/customer.balanceGet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'phone'       => $phone,
            'key_name'    => $key_name,
    ...
    public function balanceSet($address_id = 0, $balance_id = 1, $value, $customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('merchant/customer.balanceSet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'phone'       => $phone,
            'key_name'    => $key_name,
    ...
    public function balanceChangeByCustomerId($customer_id, $change_id, $value, $address_id = 0, $balance_id = 1)
    {
        return $this->balanceChange($change_id, $value, $address_id, $balance_id, $customer_id, null, null, null);
    }

    public function balanceChangeByPhone($phone, $change_id, $value, $address_id = 0, $balance_id = 1)
    {
        return $this->balanceChange($change_id, $value, $address_id, $balance_id, null, $phone, null, null);
    }

    public function balanceChangeByAdditionalKey($key_name, $key_value, $change_id, $value, $address_id = 0, $balance_id = 1)
    {
        return $this->balanceChange($change_id, $value, $address_id, $balance_id, null, null, $key_name, $key_value);
    }

    public function balanceChange($change_id, $value, $address_id = 0, $balance_id = 1, $customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        $api = $this->api;

        $data = $api->call('merchant/customer.balanceChange', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'phone'       => $phone,
            'key_name'    => $key_name,
    ...
    public function rateGet($address_id = 0, $rate_id = 1, $customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('merchant/customer.rateGet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'phone'       => $phone,
            'key_name'    => $key_name,
    ...
    public function rateSet($address_id = 0, $rate_id = 1, $value, $customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('merchant/customer.rateSet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'phone'       => $phone,
            'key_name'    => $key_name,
    ...
    public function statsGet($address_id = 0, $customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('merchant/customer.statsGet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'phone'       => $phone,
            'key_name'    => $key_name,
    ...
    public function multiBalanceGet($address_id = 0, $customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('merchant/customer.multiBalanceGet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'phone'       => $phone,
            'key_name'    => $key_name,
    ...
    public function multiRateGet($address_id = 0, $customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('merchant/customer.multiRateGet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'phone'       => $phone,
            'key_name'    => $key_name,
    ...
    public function multiStatsGet($address_id = 0, $customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('merchant/customer.multiStatsGet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'phone'       => $phone,
            'key_name'    => $key_name,
