...
class User
{
    ...
    public function callbackSet($callback)
    {
        ...
        $data = $api->call('user.callbackSet', [
            'token'    => $api->token,
            'callback' => $callback
        ]);
    ...
    public function callbackGet()
    {
        ...
        $data = $api->call('user.callbackGet', [
            'token'    => $api->token,
        ]);
    ...
    public function eventStatus()
    {
        ...
        $data = $api->call('user.eventStatus', [
            'token'    => $api->token,
        ]);
