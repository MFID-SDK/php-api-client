...
class Address
{
    ...
    public function list_($merchant_id, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/address.list', [
            'token'       => $api->token,
    ...
    public function get($address_id = null, $yandex_id = null)
    {
        ...
        $data = $api->call('service/address.get', [
            'token'      => $api->token,
    ...
    public function add($merchant_id, $yandex_id, $name, $description = '')
    {
        ...
        $data = $api->call('service/address.add', [
            'token'       => $api->token,
            'merchant_id' => $merchant_id,
            'yandex_id'   => $yandex_id,
            'name'        => $name,
    ...
    public function update($address_id, $yandex_id = null, $name = null, $description = null)
    {
        ...
        $data = $api->call('service/address.update', [
            'token'       => $api->token,
            'address_id'  => $address_id,
            'yandex_id'   => $yandex_id,
            'name'        => $name,
    ...
    public function delete($address_id)
    {
        ...
        $data = $api->call('service/address.delete', [
            'token'      => $api->token,
            'address_id' => $address_id,
        ]);
