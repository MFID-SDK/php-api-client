...
class Merchant
{
    ...
    public function list_($app_id = 0, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/merchant.list', [
            'token'  => $api->token,
            'app_id' => $app_id,
            'limit'  => $limit,
            'offset' => $offset,
    ...
    public function get($merchant_id)
    {
        ...
        $data = $api->call('service/merchant.get', [
            'token'       => $api->token,
    ...
    public function add($name, $description = '')
    {
        ...
        $data = $api->call('service/merchant.add', [
            'token'       => $api->token,
            'name'        => $name,
    ...
    public function update($merchant_id, $name = '', $description = '')
    {
        ...
        $data = $api->call('service/merchant.update', [
            'token'       => $api->token,
            'merchant_id' => $merchant_id,
            'name'        => $name,
            'description' => $description,
    ...
    public function delete($merchant_id)
    {
        ...
        $data = $api->call('service/merchant.delete', [
            'token'       => $api->token,
            'merchant_id' => $merchant_id,
        ]);
    ...
    public function offerList($merchant_id, $address_id = 0)
    {
        ...
        $data = $api->call('service/merchant.offerList', [
            'token'       => $api->token,
            'merchant_id' => $merchant_id,
    ...
    public function offerAdd($merchant_id, $address_id, $offer_id, $weight = 0)
    {
        ...
        $data = $api->call('service/merchant.offerAdd', [
            'token'       => $api->token,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
            'offer_id'    => $offer_id,
    ...
    public function offerDelete($merchant_id, $address_id, $offer_id)
    {
        ...
        $data = $api->call('service/merchant.offerDelete', [
            'token'       => $api->token,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
            'offer_id'    => $offer_id,
    ...
    public function cardGet($merchant_id, $card_id)
    {
        ...
        $data = $api->call('service/merchant.cardGet', [
            'token'       => $api->token,
            'merchant_id' => $merchant_id,
            'card_id'     => $card_id,
        ]);
