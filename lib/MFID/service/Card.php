...
class Card
{
    ...
    public function list_($merchant_id = null, $address_id = null, $issuer_id = null, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/card.list', [
            'token'       => $api->token,
    ...
    public function get($card_id = null, $pan = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('service/card.get', [
            'token'     => $api->token,
            'card_id'   => $card_id,
            'pan'       => $pan,
            'key_name'  => $key_name,
    ...
    public function add($customer_id, $merchant_id, $address_id, $pan, $status = 0)
    {
        ...
        $data = $api->call('service/card.add', [
            'token'       => $api->token,
    ...
    public function update($card_id, $status)
    {
        ...
        $data = $api->call('service/card.update', [
            'token'   => $api->token,
            'card_id' => $card_id,
            'status'  => $status,
        ]);
    ...
    public function delete($card_id)
    {
        ...
        $data = $api->call('service/card.delete', [
            'token'   => $api->token,
            'card_id' => $card_id,
        ]);
    ...
    public function merchantList($card_id, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/card.merchantList', [
            'token'   => $api->token,
            'card_id' => $card_id,
            'limit'   => $limit,
            'offset'  => $offset,
