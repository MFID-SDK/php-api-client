...
class Customer
{
    ...
    public function list_($merchant_id = null, $address_id = null, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/customer.list', [
            'token'       => $api->token,
    ...
    public function get($customer_id = null, $phone = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('service/customer.get', [
            'token'       => $api->token,
    ...
    public function add($phone, $merchant_id = 0, $address_id = 0, $email = '', $name = '', $birthday = '')
    {
        ...
        $data = $api->call('service/customer.add', [
            'token'       => $api->token,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
            'phone'       => $phone,
    ...
    public function update($customer_id, $phone = null, $email = null, $name = null, $birthday = null)
    {
        ...
        $data = $api->call('service/customer.update', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'phone'       => $phone,
            'email'       => $email,
    ...
    public function delete($customer_id, $reason)
    {
        ...
        $data = $api->call('service/customer.delete', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'reason'      => $reason,
        ]);
    ...
    public function keyAdd($customer_id, $key_name, $key_value, $key_visual, $status = 0)
    {
        ...
        $data = $api->call('service/customer.keyAdd', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'key_name'    => $key_name,
            'key_value'   => $key_value,
    ...
    public function keyDelete($customer_id, $key_name, $key_value)
    {
        ...
        $data = $api->call('service/customer.keyDelete', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'key_name'    => $key_name,
            'key_value'   => $key_value,
    ...
    public function keyConfirm($customer_id, $key_name, $key_value, $status = 1)
    {
        ...
        $data = $api->call('service/customer.keyConfirm', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'key_name'    => $key_name,
            'key_value'   => $key_value,
    ...
    public function keyList($customer_id, $key_name = null)
    {
        ...
        $data = $api->call('service/customer.keyList', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'key_name'    => $key_name,
        ]);
    ...
    public function cardList($customer_id, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/customer.cardList', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'limit'       => $limit,
            'offset'      => $offset,
    ...
    public function paycardList($customer_id, $limit = 100, $offset = 0)
    {
        $api = $this->api;

        $data = $api->call('service/customer.paycardList', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'offset'      => $offset,
            'limit'       => $limit,
    ...
    public function marketList($customer_id)
    {
        ...
        $data = $api->call('service/customer.marketList', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
        ]);
    ...
    public function merchantList($customer_id, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/customer.merchantList', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'limit'       => $limit,
            'offset'      => $offset,
    ...
    public function balanceGet($customer_id, $merchant_id, $address_id = 0)
    {
        ...
        $data = $api->call('service/customer.balanceGet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
    ...
    public function balanceSet($customer_id, $merchant_id, $value, $address_id = 0, $balance_id = 1)
    {
        ...
        $data = $api->call('service/customer.balanceSet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
    ...
    public function balanceChange($customer_id, $merchant_id, $change_id, $value, $address_id = 0, $balance_id = 1)
    {
        $api = $this->api;

        $data = $api->call('service/customer.balanceChange', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
    ...
    public function rateGet($customer_id, $merchant_id, $address_id = 0)
    {
        ...
        $data = $api->call('service/customer.rateGet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
    ...
    public function rateSet($customer_id, $merchant_id, $value, $address_id = 0, $rate_id = 1)
    {
        ...
        $data = $api->call('service/customer.rateSet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
    ...
    public function statsGet($customer_id, $merchant_id, $address_id = 0)
    {
        ...
        $data = $api->call('service/customer.statsGet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
    ...
    public function statsSet($customer_id, $merchant_id, $count, $sum, $discount = 0, $address_id = 0)
    {
        ...
        $data = $api->call('service/customer.statsSet', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
    ...
    public function statsChange($customer_id, $merchant_id, $count, $sum, $discount = 0, $address_id = 0)
    {
        ...
        $data = $api->call('service/customer.statsChange', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'merchant_id' => $merchant_id,
            'address_id'  => $address_id,
    ...
    public function offerConnect($customer_id, $offer_id, $address_id, $info = 0)
    {
        ...
        $data = $api->call('service/customer.offerConnect', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'offer_id'    => $offer_id,
            'address_id'  => $address_id,
    ...
    public function infoShare($customer_id, $merchant_id)
    {
        ...
        $data = $api->call('service/customer.infoShare', [
            'token'       => $api->token,
            'customer_id' => $customer_id,
            'merchant_id' => $merchant_id,
        ]);
