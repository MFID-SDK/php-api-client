...
class Emission
{
    ...
    public function reserve($count, $series_name, $series_description = '')
    {
        ...
        $data = $api->call('service/emission.reserve', [
            'token'  => $api->token,
    ...
    public function confirm($series_name, $status = 0)
    {
        ...
        $data = $api->call('service/emission.confirm', [
            'token'  => $api->token,
            'series_name' => $series_name,
            'status' => $status,
        ]);
    ...
    public function seriesList($app_id = 0, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/emission.seriesList', [
            'token'  => $api->token,
            'app_id' => $app_id,
            'limit' => $limit,
            'offset' => $offset,
    ...
    public function seriesInfo($series_id = null, $series_name = null)
    {
        ...
        $data = $api->call('service/emission.seriesInfo', [
            'token'  => $api->token,
            'series_id' => $series_id,
            'series_name' => $series_name,
        ]);
    ...
    public function numberList($series_id = 0, $app_id = 0, $merchant_id = 0, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/emission.numberList', [
            'token'  => $api->token,
            'series_id' => $series_id,
            'app_id' => $app_id,
    ...
    public function numberInfo($pan = null, $key_name = null, $key_value = null)
    {
        ...
        $data = $api->call('service/emission.numberInfo', [
            'token'  => $api->token,
            'pan' => $pan,
            'key_name' => $key_name,
            'key_value' => $key_value,
    ...
    public function matching($data)
    {
        ...
        $data = $api->call('service/emission.matching', [
            'token'  => $api->token,
            'data' => $data,
        ]);
    ...
    public function matchingStatus($matching_key, $details = null)
    {
        ...
        $data = $api->call('service/emission.matchingStatus', [
            'token'  => $api->token,
