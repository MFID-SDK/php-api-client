...
class App
{
    ...
    public function list_($user_id = null, $type = null)
    {
        ...
        $data = $api->call('service/app.list', [
            'token'   => $api->token,
            'user_id' => $user_id,
            'type'    => $type,
        ]);
    ...
    public function update($app_id, $name = null, $description = null)
    {
        ...
        $data = $api->call('service/app.update', [
            'token'       => $api->token,
            'app_id'      => $app_id,
            'name'        => $name,
            'description' => $description,
    ...
    public function delete($app_id, $reason)
    {
        ...
        $data = $api->call('service/app.delete', [
            'token'  => $api->token,
            'app_id' => $app_id,
            'reason' => $reason,
        ]);
    ...
    public function userList($app_id)
    {
        ...
        $data = $api->call('service/app.userList', [
            'token'  => $api->token,
            'app_id' => $app_id,
        ]);
    ...
    public function userGet($user_id)
    {
        ...
        $data = $api->call('service/app.userGet', [
            'token'   => $api->token,
            'user_id' => $user_id,
        ]);
    ...
    public function userAdd($app_id, $login, $password, $access)
    {
        ...
        $data = $api->call('service/app.userAdd', [
            'token'    => $api->token,
            'app_id'   => $app_id,
            'login'    => $login,
            'password' => $password,
    ...
    public function userUpdate($app_id, $password = null, $access = null)
    {
        ...
        $data = $api->call('service/app.userUpdate', [
            'token'    => $api->token,
            'app_id'   => $app_id,
            'password' => $password,
            'access'   => $access,
    ...
    public function userDelete($user_id, $reason)
    {
        ...
        $data = $api->call('service/app.userDelete', [
            'token'   => $api->token,
            'user_id' => $user_id,
            'reason'  => $reason,
        ]);
