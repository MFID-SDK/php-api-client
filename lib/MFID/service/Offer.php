...
class Offer
{
    ...
    public function list_($merchant_id = 0, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/offer.list', [
            'token'       => $api->token,
    ...
    public function get($offer_id)
    {
        ...
        $data = $api->call('service/offer.get', [
            'token'    => $api->token,
            'offer_id' => $offer_id,
        ]);
    ...
    public function add($merchant_id, $name, $description = '', $percent = 0, $price = 0, $weight = 0)
    {
        ...
        $data = $api->call('service/offer.add', [
            'token'       => $api->token,
            'merchant_id' => $merchant_id,
            'name'        => $name,
    ...
    public function update($offer_id, $name, $description = '', $percent = 0, $price = 0, $weight = 0)
    {
        ...
        $data = $api->call('service/offer.update', [
            'token'       => $api->token,
            'offer_id'    => $offer_id,
            'name'        => $name,
            'description' => $description,
    ...
    public function delete($offer_id)
    {
        ...
        $data = $api->call('service/offer.delete', [
            'token'    => $api->token,
            'offer_id' => $offer_id,
        ]);
