...
class Market
{
    ...
    public function list_($market_id = null, $merchant_id = null, $limit = null, $offset = null)
    {
        ...
        $data = $api->call('service/market.list', [
            'token'       => $api->token,
            'market_id'   => $market_id,
    ...
    public function get($market_id, $merchant_id)
    {
        ...
        $data = $api->call('service/market.get', [
            'token'       => $api->token,
            'market_id'   => $market_id,
            'merchant_id' => $merchant_id,
        ]);
    ...
    public function add($market_id, $merchant_id, $weight = 0)
    {
        ...
        $data = $api->call('service/market.add', [
            'token'       => $api->token,
            'market_id'   => $market_id,
            'merchant_id' => $merchant_id,
            'weight'      => $weight,
    ...
    public function update($market_id, $merchant_id, $weight = 0)
    {
        ...
        $data = $api->call('service/market.update', [
            'token'       => $api->token,
            'market_id'   => $market_id,
            'merchant_id' => $merchant_id,
            'weight'      => $weight,
    ...
    public function delete($market_id, $merchant_id)
    {
        ...
        $data = $api->call('service/market.delete', [
            'token'       => $api->token,
            'market_id'   => $market_id,
            'merchant_id' => $merchant_id,
        ]);
